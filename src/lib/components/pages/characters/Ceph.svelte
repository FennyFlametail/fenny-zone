...
<Character image="/characters/ceph.webp">
	<ul>
		...
		<li>
			Age: 21
			<ul>
				<li>two grades below Fenny</li>
			</ul>
		</li>
		<li>Height: 5 ft 2 in (1.57 m)</li>
		<li>Pronouns: he/they</li>
		<li>Orientation: gay</li>
		<li>
			Personality: timid, anxious, insecure, usually very reserved but can get excited about things
			he likes
			<ul>
		...
		<li>
			Favorite drink: matcha latte or Calpico
			<ul>
		...
		<li>
			Artwork by <a target="_blank" href="https://www.furaffinity.net/user/WickedForster/"
				>WickedForster</a
			>
		</li>
	</ul>

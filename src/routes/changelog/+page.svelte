...
<TextEdit>
	<div>
		...
		<h3>2026-04-21</h3>
		<ul>
			<li>Restore selected System Preferences pane on reload</li>
		</ul>
		<h3>2026-04-20</h3>
		<ul>
		...
		<ul>
			...
			<li>Improved Bluesky feed parsing</li>
		...
		<h3>2026-02-10</h3>
		<ul>
			<li>Added link previews to Bluesky app</li>
		</ul>
		<h3>2026-02-09</h3>
		<ul>
			<li>Added Bluesky app</li>
		</ul>
		<h3>2026-02-05</h3>
		<ul>
			<li>Updated character profiles</li>
		</ul>
		<h3>2026-01-24</h3>
		<ul>
